...
import { IconExternal, IconSparkles } from "../components/common/Icons.jsx";
...
export default function ChatPage() {
  ...
  return (
    <div className="relative flex flex-col h-[100dvh] overflow-hidden bg-slate-50 dark:bg-[#060913] text-slate-800 dark:text-slate-100 cyber-grid-bg">
      {/* Top Announcement Banner (Dismissible) */}
      {showBanner && (
        <div className="relative z-50 bg-gradient-to-r from-cyan-600 via-primary-600 to-indigo-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium flex items-center justify-between shadow-md shrink-0">
          <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 text-center w-full px-2 min-w-0">
            ...
            <a
              ...
              className="hidden md:inline-flex items-center gap-1 font-mono font-semibold underline hover:text-cyan-200 shrink-0 ml-1.5"
            >
